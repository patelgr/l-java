...
tasks.withType<JavaCompile>().configureEach {
    ...
    options.errorprone {
        ...
        check("ComparisonOutOfRange", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("EmptyIf", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("Finalize", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("InsecureCryptoUsage", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("MissingDefault", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("MixedMutabilityReturnType", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("NullableConstructor", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("OptionalNotPresent", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("ReturnsNullCollection", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("StreamToString", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("StringSplitter", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("TryFailRefactoring", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("InterfaceWithOnlyStatics", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("MissingSummary", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("UnusedNestedClass", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)

        // ---- TEMPLATE SAFETY ----
        check("AlreadyChecked", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("DefaultCharset", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("DurationToLongTimeUnit", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("ImmutableAnnotationChecker", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("JavaUtilDate", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("LockNotBeforeTry", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("NonAtomicVolatileUpdate", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("PreferJavaTimeOverload", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("PrimitiveAtomicReference", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("StaticAssignmentInConstructor", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("StaticGuardedByInstance", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("StringCaseLocaleUsage", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("SynchronizeOnNonFinalField", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("ThreadJoinLoop", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("ThreadLocalUsage", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("ThreadPriorityCheck", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("FieldCanBeFinal", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("InconsistentCapitalization", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        check("InconsistentOverloads", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
        ...
        check("OverrideThrowableToString", net.ltgt.gradle.errorprone.CheckSeverity.ERROR)
